...
// auth services
export const loginAsync = (creds, headers) => request.post("/auth/login", creds, headers);
export const registerAsync = (creds, headers) => request.post("/auth/register", creds, headers);
